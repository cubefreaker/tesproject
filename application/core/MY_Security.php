...
class MY_Security extends CI_Security
{
    ...
    {
    	$ExceptUri = [
    		'api/flight/CallbackOpsigo',
    		'api/flight/CallbackOpsigoFlight',
    		'flight/midtrans/notification',
    		'flight/midtrans/CallbackMidtrans',
    		'flight/midtrans/returnFinish',
    		'flight/midtrans/returnUnFinish',
    		'flight/midtrans/returnError',
    		'flight/midtrans/redirectToPay',
    		'flight/midtrans/SettlePayment',
    		'flight/payment/returnCredit',
    		'flight/payment/returnDebit'
    	];
        $uri = load_class('URI', 'core');
    	// Check if URI has been whitelisted from CSRF checks
		if (in_array($uri->uri_string(), $ExceptUri) ) {
			return $this;
		}
