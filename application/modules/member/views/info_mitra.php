                ...
                <div class="img-thumbnail text-center" style="margin-bottom:35px;">
                        ...
                        <?php 
                            if ($Member->img_thum == NULL || $Member->img_thum == '') {
                                echo '<img id="imgbrand" height="200" width="200" src="'.base_url().'assets/images/profile/profile.png">';
                            } else {
                                echo '<img id="imgbrand" height="200" width="200" src="'.base_url().'assets/images/profile/'.$Member->img_thum.'">';
                            }
                        ?>
