    ...
    <div class="panel panel-default shad">
        <div class="panel-body"> 
            <div class="tab_container" style="margin-left: 10%">
                ...
                <label class="labels" for="tab1"><span style="">Seller</span></label>
                                                ...
                                                <div class="panel-heading" role="tab" id="headingTwo">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                            <span class="pull-right glyphicon glyphicon-collapse-down"> </span>IP WHITELIST
                                                        </a>
                                                    </h4>
                                                </div>
                                                                    ...
                                                                    <div class="panel-body" >        
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="controls col-md-8"> 
                                                                                    <input class="input-md form-control" name="ip_dev_1" id="ip_dev_1" placeholder="IP Address (1)" style="margin-bottom: 10px" type="text" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="controls col-md-8"> 
                                                                                    <input class="input-md form-control" name="ip_production" id="ip_production" placeholder="Production IP Address (only 1)" style="margin-bottom: 10px" type="text" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="controls col-md-8"> 
                                                                                    <input class="input-md form-control" name="protocols" placeholder="Protocols" style="margin-bottom: 10px" id="protocols" type="text" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="controls col-md-8"> 
                                                                                    <input class="input-md form-control" name="ports" id="ports" placeholder="Ports" style="margin-bottom: 10px" type="text" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
